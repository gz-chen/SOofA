...
template<typename IntType=Type_Int,typename RingType=Ring<IntType>,
	...
	//`std::is_base_of<Ring_Base<IntType>,RingType>::value>::type>
	is_space_type<RingType>::value>::type>
class Element;
//}(classes in this hpp)
/****************************************************************************************************/
...
template<typename Tp>
class is_space_type: public ::std::false_type{
};
...
class is_sapce_type<Ring_Base<IntType,TraitsCheck> >:
...
class Element{
	...
	public:
		...
		//Type: the ring:
		typedef RingType type_ring;
		typedef type_ring type_space;
		//Type: integer:
		typedef typename type_ring::type_int type_int;
		//Type: signed integer:
		typedef typename type_ring::type_sint type_sint;
		//Type: unsigned integer:
		typedef typename type_ring::type_uint type_uint;
		//Type: for storing the value:
		typedef typename type_ring::type_val type_val;
		typedef typename type_ring::value_type value_type;
		//Type: for storing the modulo:
		typedef typename type_ring::type_mod type_mod;
		//Type: the pointer to the ring:
		typedef std::shared_ptr<type_ring const> type_ptr_ring;
		typedef type_ptr_ring type_ptr_space;
		...
		template<typename AuxIntType,
			typename=typename std::enable_if<std::is_convertible<AuxIntType,type_val>::value>::type>
		Element(AuxIntType const & num_value,type_ring const & ring);
		template<typename AuxIntType,
			typename=typename std::enable_if<std::is_convertible<AuxIntType,type_val>::value>::type>
		Element(AuxIntType const & num_value,type_ptr_ring const & ptr_ring);
		template<typename AuxIntType,
			typename=typename std::enable_if<std::is_convertible<AuxIntType,type_val>::value>::type>
		...
		type_ring const & space() const;
		type_ptr_ring const & ptr_space() const;
	...
	protected:
		//member value:
		type_ptr_ring m_ptr_ring;
		type_val m_value;
		
		//static value:
		static type_ptr_ring val_ptr_ring_invalid;
		static type_ptr_ring val_ptr_ring_universal;
}; //class Element;
